	...
	<div class="jumbotron">
		<div class="container">
			<ul class="breadcrumbs">
				...
				<li class="active">
					<a href="{{ url()->current() }}">aktualności</a>
				</li>
			</ul>
			<h1>Aktualności</h1>
		</div>
	...
	<div class="news container">
		...
		<div class="newest">
			<div class="left col-xs-6 col-md-6">
				<p class="date">{{ $first->publish_at}}</p>
				<h3 class="title">{{ $first->title}}</h3>
				<p class="description">{{ $first->info}}</p>
				<a href="{{ url('aktualnosci'.$first->url) }}">Czytaj dalej</a>

			</div>
			<div class="right col-xs-6 col-md-6">
				<img src="{{ url($first->thumb()) }}" alt="" class="header">
			</div>
		</div>
	...
	<div class="news container">
		...
		<div class="row">
			...
			<div class="col-xs-12 col-md-4 single-news">
				<img src="{{ url($post->thumb())}}" alt="" class="header">
				<div>

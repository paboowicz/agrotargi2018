...
<body class="forExhibitors-drive">
	<header class="header">
		<div class="logo">
			<a href="{{ url('/') }}/">
		...
		<div class="row">
			<div class="col-xs-12 no-padding">
				<div class="info-banner">
					...
					<h4>Specjalnie dla naszych wystawców nawiązaliśmy współpracę z Bazą Noclegową dostępną w pobliżu II edycji Agro Targów Wschód.</h4>
				</div>
			</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-xs-12">
				<div class="text-box">
					<p>Rekomendowane przez nas miejsca, spełnią potrzeby nawet najbardziej wymagających. Polecana przez nas baza noclegowa
						dostępna wkrótce.</p>
